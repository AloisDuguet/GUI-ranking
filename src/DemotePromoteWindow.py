...
class DemotePromoteWindow(GroupWindow):
    def __init__(self, root, competitors, nameGroup):
        ...
        GroupWindow.init(self, root, competitors, nameGroup, explanationMessage, DemotePromoteElement, self.promote, self.demote)
        self.toBePromoted = []
        self.toBeDemoted = []
